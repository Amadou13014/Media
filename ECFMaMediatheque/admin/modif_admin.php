...
<main class="main_compte_pu">
    <div class="container_compte_pu">
        <div class="cote_right_compte_pu">
            ...
            <a class="navigationitemp" href="/admin/modif_admin.php">Modifier<span></span></a>
            <a class="navigationitemp" href="modifpwd.php">Supprimer l'utilisateur<span></span></a>

            <div class="trait"></div>
        </div>
        <div class="cote_left_compte_pu">

            <form action="php_back/mdf_user_back.php" method="post" class="form_input">
