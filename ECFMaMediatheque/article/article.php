...
<?php include_once "../php_back/article_back.php" ?>
<!DOCTYPE html>
<html lang="en">
...
<main class="main_compte_pu">
    <div class="container_compte_pu">
        <div class="cote_right_compte_pu">
            <a class="navigationitemp" href="/article/article.php">Publier un article<span></span></a>
            <a class="navigationitemp" href="/users/modif_article.php?id_article=<?php echo $stmt1['id_article'] ?>">Modifier un article<span></span></a>
